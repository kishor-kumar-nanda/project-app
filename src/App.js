            ...
            <div>
              <table border="1px" width="100%">
                <tr>
                  ...
                  <td>
                    <span>{dynamicData.first_name}</span>
                  </td>
                  <td>
                    <span>{dynamicData.last_name}</span>
                  </td>
                  <td>
                    <span>{dynamicData.company_name}</span>
                  </td>
                  <td>
                    <span>{dynamicData.city}</span>
                  </td>
                  <td>
                    <span>{dynamicData.state}</span>
                  </td>
                  <td>
                    <span>{dynamicData.zip}</span>
                  </td>
                  <td>
                    <span>{dynamicData.email}</span>
                  </td>
                  <td>
                    <span>{dynamicData.web}</span>
                  </td>
                  <td>
                    <span>{dynamicData.age}</span>
                  </td>
                </tr>
              </table>
            </div>
